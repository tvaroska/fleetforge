...
Telemetry rides the health channel of the device contract (DESIGN.md → identity/health).
...
| R4-BE-1 | Ingest + persist health/telemetry; expose via API + event stream | P0 | 1.5d |
